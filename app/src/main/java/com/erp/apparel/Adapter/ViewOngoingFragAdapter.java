...
public class ViewOngoingFragAdapter extends RecyclerView.Adapter<ViewOngoingFragAdapter.RecViewHolder> {
   ...
   private ArrayList<ViewOngoingModel> demolist;
    ...
    public ViewOngoingFragAdapter(Context context, Fragment fragment, ArrayList<ViewOngoingModel> demolist) {
