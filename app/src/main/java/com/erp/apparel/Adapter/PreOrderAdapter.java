...
public class PreOrderAdapter extends RecyclerView.Adapter<PreOrderAdapter.RecViewHolder> {
    ...
    public PreOrderAdapter(Context context, ArrayList<PreOrderModel> demolist) {
        this.context = context;
        this.demolist = demolist;
        this.pdfEvents=(PdfEvents) context;
    }
