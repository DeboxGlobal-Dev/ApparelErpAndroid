...
public class ProcessLightFragAdapter extends RecyclerView.Adapter<ProcessLightFragAdapter.RecViewHolder> {


    Context context;
    Fragment fragment;
   private ArrayList<ProcessLightModel> demolist;
    ViewEvents viewEvents;

    public ProcessLightFragAdapter(Context context, Fragment fragment, ArrayList<ProcessLightModel> demolist) {
    ...
    public RecViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.detail_processlight, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecViewHolder holder, final int position) {
        ...
        holder.m_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               viewEvents.onDelayedClick(demolist.get(position),position);
            }
        });
    }
    ...
    public void filterList(ArrayList<ProcessLightModel> filterlist) {
        demolist=filterlist;
