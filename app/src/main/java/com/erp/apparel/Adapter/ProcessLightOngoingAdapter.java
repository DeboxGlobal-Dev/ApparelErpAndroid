...
public class ProcessLightOngoingAdapter extends RecyclerView.Adapter<ProcessLightOngoingAdapter.RecViewHolder> {
   ...
   private ArrayList<ProcessLightOngoingModel> demolist;
    ...
    public ProcessLightOngoingAdapter(Context context, ArrayList<ProcessLightOngoingModel> demolist) {
