...
public class ViewUpcomingAdapter extends RecyclerView.Adapter<ViewUpcomingAdapter.RecViewHolder> {
  ...
  private ArrayList<ViewUpcomingModel> demolist;
    ...
    public ViewUpcomingAdapter(Context context, ArrayList<ViewUpcomingModel> demolist) {
