...
public class ViewDelayedFragAdapter extends RecyclerView.Adapter<ViewDelayedFragAdapter.RecViewHolder> {
   ...
   CompleteEvents completeEvents;
    ...
    public ViewDelayedFragAdapter(Context context, Fragment fragment, ArrayList<ViewDelayedModel> demolist) {
