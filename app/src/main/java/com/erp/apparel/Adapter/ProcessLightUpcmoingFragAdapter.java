...
public class ProcessLightUpcmoingFragAdapter extends RecyclerView.Adapter<ProcessLightUpcmoingFragAdapter.RecViewHolder> {
   ...
   private ArrayList<ProcessLightUpcomingModel> demolist;
    ...
    public ProcessLightUpcmoingFragAdapter(Context context, Fragment fragment, ArrayList<ProcessLightUpcomingModel> demolist) {
