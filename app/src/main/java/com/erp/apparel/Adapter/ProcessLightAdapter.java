...
public class ProcessLightAdapter extends RecyclerView.Adapter<ProcessLightAdapter.RecViewHolder> {
   ...
   private ArrayList<ProcessLightModel> demolist;
    ...
    public ProcessLightAdapter(Context context, ArrayList<ProcessLightModel> demolist) {
